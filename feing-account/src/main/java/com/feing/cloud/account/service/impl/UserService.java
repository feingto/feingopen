package com.feing.cloud.account.service.impl;

import com.feing.cloud.account.repository.UserRepository;
...
import com.feing.cloud.domain.account.*;
import com.feing.cloud.dto.oauth.ClientDetailApiDTO;
import com.feing.cloud.dto.oauth.ClientDetailDTO;
import com.feing.cloud.kit.reflection.ConvertKit;
import com.feing.cloud.orm.jdbc.JdbcTemplateKit;
import com.feing.cloud.orm.jdbc.model.Records;
...
import com.feing.cloud.remote.SignClient;
...
public class UserService extends BaseService<User, String> implements IUser {
    ...
    public List<Resource> parseUserResource(String userId, String roleId) {
        ...
        if (user.isSystemAdmin()) {
            ...
            if (roleIdList.size() > 0 || !StringUtils.isEmpty(roleId)) {
                // 根据角色过滤资源
