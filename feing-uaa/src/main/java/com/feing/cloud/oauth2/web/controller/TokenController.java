...
import com.feing.cloud.dto.oauth.AccessTokenDTO;
import com.feing.cloud.dto.oauth.ClientDetailDTO;
import com.feing.cloud.dto.oauth.OAuth2TokenDTO;
    ...
    private Collection<AccessTokenDTO> enhance(Collection<OAuth2AccessToken> tokens) {
        ...
        for (OAuth2AccessToken accessToken : tokens) {
            ...
            if (authentication != null) {
                String userName = !StringUtils.isEmpty(authentication.getName()) ? authentication.getName() : "Unknown";
