...
import com.feing.cloud.remote.account.fallback.ResourceClientFallback;
 ...
 * @author longfei
 */
@FeignClient(name = "feing-account", configuration = AuthClientCodecConfiguration.class, fallback = ResourceClientFallback.class)
