...
import com.feing.cloud.remote.account.fallback.UserClientFallback;
 ...
 * @author longfei
 */
@FeignClient(name = "feing-account", configuration = AuthClientCodecConfiguration.class, fallback = UserClientFallback.class)
